...
Babylon.Controller.prototype.perform = function(controller_name, action_name, options) {
...
Babylon.Controller.prototype.render = function(options) {
    ...
    if(options["view"]){
        ...
        return this.render({"view": Babylon.Views[this.controller_name][this.action_name]});
    }
};
