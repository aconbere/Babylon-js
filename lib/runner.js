...
Babylon.Runner.prototype.on_connection_failed = function() {
    Babylon.log.debug("Connection Failed");
    this.call_on_observers("on_connection_failed");
};
...
Babylon.Runner.prototype.on_authenticating = function() {
    ...
    this.call_on_observers("on_authenticating");
};

Babylon.Runner.prototype.on_authentication_failed = function() {
    Babylon.log.debug("Authentication Failed");
    this.call_on_observers("on_authentication_failed");
};

Babylon.Runner.prototype.on_error = function() {
    Babylon.log.debug("Error");
    this.call_on_observers("on_error");
};
