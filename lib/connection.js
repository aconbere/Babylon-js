...
Babylon.Connection.prototype.on_error = function() {
    this.handler.on_error();
};
Babylon.Connection.prototype.on_authenticating = function() {
    this.handler.on_authenticating();
};
Babylon.Connection.prototype.on_authentication_failed = function() {
    this.handler.on_authentication_failed();
};
