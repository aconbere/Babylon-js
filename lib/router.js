...
/* The Router class builds routes, and executes them. Taking the provided
 * stanza to the controller and calling the action on it.
 */
...
Babylon.Router.prototype.route = function(stanza) {
    ...
    var wrapped_stanza = $("<div></div>").append(Strophe.serialize(stanza));
